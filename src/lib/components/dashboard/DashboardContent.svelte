<script lang="ts">
	...
	import StatsCard from '@/lib/components/dashboard/cards/StatsCard.svelte';
	import LanguageChart from '@/lib/components/dashboard/charts/LanguageChart.svelte';
	import StarsChart from '@/lib/components/dashboard/charts/StarsChart.svelte';

	import type { DashboardStats, LanguageUsage, Repository } from '@/lib/types';
    import { mockDashboardStats, mockLanguageUsage, mockRepositories } from '@/lib/stores/services/mock/data';
